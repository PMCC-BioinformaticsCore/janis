...
class SplitMultiAllele2(CommandTool):
    ...
    vardict_inputs = [
        ...
        ToolInput("indexedBam", String(optional=True), prefix="-b", position=1, doc="The indexed BAM file"),
        ...
        ToolInput("geneEndCol", Int(optional=True), prefix="-E", position=1, doc="The column for region end, e.g. gene end"),
