...
from Pipeline import CommandTool, ToolInput, File, ToolOutput, ToolArgument, Array, String, Boolean, Int
...
class GatkPrintReadsBase(Gatk4Base, ABC):
    ...
    def inputs(self):
        return [
            *super(GatkPrintReadsBase, self).inputs(),
            ...
            *GatkPrintReadsBase.additional_args
        ]
