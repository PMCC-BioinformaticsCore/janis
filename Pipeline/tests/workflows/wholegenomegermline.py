...
from Pipeline import Input, String, Step, Directory, Workflow, Array, Output
...
from Pipeline.bioinformatics.tools.gatk4.baserecalibrator.latest import \
    Gatk4BaseRecalibratorLatest as Gatk4BaseRecalibrator
from Pipeline.bioinformatics.tools.gatk4.genotypeconcordance.latest import \
    Gatk4GenotypeConcordanceLatest as Gatk4GenotypeConcordance
from Pipeline.bioinformatics.tools.gatk4.haplotypecaller.latest import \
