...
Tool path: ``from janis_bioinformatics.tools.bwa import BwaMem_SamToolsView``
...
Docker
******
``michaelfranklin/bwasamtools:0.7.17-1.9``
...
threads                      Optional<Integer>         -t                     2  Number of threads. (default = 1)
