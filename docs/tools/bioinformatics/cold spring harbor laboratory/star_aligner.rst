...
outFileNamePrefix  Optional<Filename>        --outFileNamePrefix  <janis_core.types.common_data_types.String object at 0x10e94e550>  string: output files name prefix (including full or relative path). Can only be defined on the command line.
