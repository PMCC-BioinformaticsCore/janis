...
Janis is workflow framework that uses Python to construct a declarative workflow. It supports converting your pipeline to the Common Workflow Language (CWL) and Workflow Description Language (WDL) for execution and archival.
...
.. note::
   At the end of the execution, we can use Janis to move our output files into a predictable output structure.
