...
Currently no walkthrough tutorials for translation of Galaxy to WDL. 
...
.. code-block:: bash
   ...
   janis translate --from galaxy --to wdl galaxy_tool/samtools_flagstat.xml
...
.. code-block:: bash
   ...
   janis translate --from galaxy --to wdl galaxy_workflow/rna-seq-reads-to-counts.ga
