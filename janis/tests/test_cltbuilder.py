...
class TestInputSelector(unittest.TestCase):
    ...
    def test_inputselector_1param(self):
        ...
        self.assertEqual('InputSelector(input_to_select="filename")', clt.get_string_repr(i))


class TestToolOutput(unittest.TestCase):
    def test_tooloutput(self):
        o = ToolOutput("tag", String())
        self.assertEqual('ToolOutput(tag="tag", output_type=String())', clt.get_string_repr(o))
...
class TestDateTime(unittest.TestCase):
    def test_datetime(self):
        ...
        self.assertEqual('datetime.fromisoformat("1985-11-26T01:20:00")', clt.get_string_repr(dt))
