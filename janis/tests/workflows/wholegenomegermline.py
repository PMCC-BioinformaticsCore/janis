...
from janis import Input, String, Step, Directory, Workflow, Array, Output, get_tool
...
from janis.bioinformatics.tools.bcftools.norm.latest import BcfToolsNormLatest as BcfToolsNorm
...
from janis.bioinformatics.tools.gatk4.haplotypecaller.latest import \
